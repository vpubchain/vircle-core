...
public:
    ...
    virtual bool IsVircleVersion() const { return false; }
...
public:
    ...
    bool IsVircleVersion() const override { return txTo && txTo->IsVircleVersion(); }
...
extern const BaseSignatureCreator& DUMMY_SIGNATURE_CREATOR_VIRCLE;
