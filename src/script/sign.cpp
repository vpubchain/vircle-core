...
bool ProduceSignature(const SigningProvider& provider, const BaseSignatureCreator& creator, const CScript& fromPubKey, SignatureData& sigdata)
{
    ...
    bool fIsP2SH = creator.IsVircleVersion()
...
public:
    ...
    bool is_vircle_tx = false;
    bool IsVircleVersion() const override { return is_vircle_tx; }
};
...
SignatureData DataFromTransaction(const CMutableTransaction& tx, unsigned int nIn, const std::vector<uint8_t> &amount, const CScript &scriptPubKey)
{
    ...
    extractor_checker.is_vircle_tx = tx.IsVircleVersion();
...
class DummySignatureCheckerVircle : public DummySignatureChecker
{
// IsVircleVersion() must return true to skip stack evaluation
public:
    DummySignatureCheckerVircle() : DummySignatureChecker() {}
    bool IsVircleVersion() const override { return true; }
};
const DummySignatureCheckerVircle DUMMY_CHECKER_VIRCLE;

class DummySignatureCreatorVircle : public DummySignatureCreator {
public:
    DummySignatureCreatorVircle() : DummySignatureCreator(33, 32) {}
...
const BaseSignatureCreator& DUMMY_SIGNATURE_CREATOR_VIRCLE = DummySignatureCreatorVircle();
