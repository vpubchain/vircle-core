...
public:
    ...
    {
        if (::IsVircleWallet(&m_wallet))
            m_wallet_part = GetVircleWallet(&m_wallet);
    }
    ...
    CHDWallet *getVircleWallet() override
    {
        return m_wallet_part;
    }
