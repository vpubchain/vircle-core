...
const std::pair<const char*, CAmount> genesisOutputs[] = {       
    //wallet-1
    std::make_pair("adf0850d6f00fcd6ca7bb79786aea308091d433e",  10 * COIN),
    std::make_pair("adf0850d6f00fcd6ca7bb79786aea308091d433e",  10 * COIN),
    std::make_pair("adf0850d6f00fcd6ca7bb79786aea308091d433e",  10 * COIN),
    std::make_pair("adf0850d6f00fcd6ca7bb79786aea308091d433e",  10 * COIN),
    std::make_pair("adf0850d6f00fcd6ca7bb79786aea308091d433e",  10 * COIN),
    ...
    //wallet-2
    std::make_pair("ea0cf04f81fd412694a57eba6462c60638440c5b",  10 * COIN),
    std::make_pair("ea0cf04f81fd412694a57eba6462c60638440c5b",  10 * COIN),
    std::make_pair("ea0cf04f81fd412694a57eba6462c60638440c5b",  10 * COIN),
    std::make_pair("ea0cf04f81fd412694a57eba6462c60638440c5b",  10 * COIN),
    std::make_pair("ea0cf04f81fd412694a57eba6462c60638440c5b",  10 * COIN),
    ...
    //wallet-3
    std::make_pair("9a7b961c584b3d23fe74f3ed6b81db63c282c6e2",  10 * COIN),
    std::make_pair("9a7b961c584b3d23fe74f3ed6b81db63c282c6e2",  10 * COIN),
    std::make_pair("9a7b961c584b3d23fe74f3ed6b81db63c282c6e2",  10 * COIN),
    std::make_pair("9a7b961c584b3d23fe74f3ed6b81db63c282c6e2",  10 * COIN),
    std::make_pair("9a7b961c584b3d23fe74f3ed6b81db63c282c6e2",  10 * COIN),
    ...
    //wallet-4
    std::make_pair("71e28d489491624728e6ed985cadeaeaeae46f67",  10 * COIN),
    std::make_pair("71e28d489491624728e6ed985cadeaeaeae46f67",  10 * COIN),
    std::make_pair("71e28d489491624728e6ed985cadeaeaeae46f67",  10 * COIN),
    std::make_pair("71e28d489491624728e6ed985cadeaeaeae46f67",  10 * COIN),
    std::make_pair("71e28d489491624728e6ed985cadeaeaeae46f67",  10 * COIN),
    ...
    //wallet-5
    std::make_pair("faaed71fef4cfa5c7f94cdb800f503b40c2a256c",  10 * COIN),
    std::make_pair("faaed71fef4cfa5c7f94cdb800f503b40c2a256c",  10 * COIN),
    std::make_pair("faaed71fef4cfa5c7f94cdb800f503b40c2a256c",  10 * COIN),
    std::make_pair("faaed71fef4cfa5c7f94cdb800f503b40c2a256c",  10 * COIN),
    std::make_pair("faaed71fef4cfa5c7f94cdb800f503b40c2a256c",  10 * COIN),
    ...
    //wallet-6
    std::make_pair("fd8af4f92116b2d7d0b5a6e6ac790c8b5b9b42a8",  10 * COIN),
    std::make_pair("fd8af4f92116b2d7d0b5a6e6ac790c8b5b9b42a8",  10 * COIN),
    std::make_pair("fd8af4f92116b2d7d0b5a6e6ac790c8b5b9b42a8",  10 * COIN),
    std::make_pair("fd8af4f92116b2d7d0b5a6e6ac790c8b5b9b42a8",  10 * COIN),
    std::make_pair("fd8af4f92116b2d7d0b5a6e6ac790c8b5b9b42a8",  10 * COIN),
    ...
    //wallet-7
    std::make_pair("0f84624bac570b4f669ac92292078973477969ed",  10 * COIN),
    std::make_pair("0f84624bac570b4f669ac92292078973477969ed",  10 * COIN),
    std::make_pair("0f84624bac570b4f669ac92292078973477969ed",  10 * COIN),
    std::make_pair("0f84624bac570b4f669ac92292078973477969ed",  10 * COIN),
    std::make_pair("0f84624bac570b4f669ac92292078973477969ed",  10 * COIN),
    ...
    //wallet-8
    std::make_pair("a1d695cc5fb6b09f8bf4753db015d23652af15d0",  10 * COIN),
    std::make_pair("a1d695cc5fb6b09f8bf4753db015d23652af15d0",  10 * COIN),
    std::make_pair("a1d695cc5fb6b09f8bf4753db015d23652af15d0",  10 * COIN),
    std::make_pair("a1d695cc5fb6b09f8bf4753db015d23652af15d0",  10 * COIN),
    std::make_pair("a1d695cc5fb6b09f8bf4753db015d23652af15d0",  10 * COIN),
    ...
    //wallet-9
    std::make_pair("7f5c5f3309d7653412861ca678cd97ab5f994aba",  10 * COIN),
    std::make_pair("7f5c5f3309d7653412861ca678cd97ab5f994aba",  10 * COIN),
    std::make_pair("7f5c5f3309d7653412861ca678cd97ab5f994aba",  10 * COIN),
    std::make_pair("7f5c5f3309d7653412861ca678cd97ab5f994aba",  10 * COIN),
    std::make_pair("7f5c5f3309d7653412861ca678cd97ab5f994aba",  10 * COIN),
    ...
    //wallet-10
    std::make_pair("8adb2363b2dbc0251a4a6b65a5bddb185d0bdad2",  10 * COIN),
    std::make_pair("8adb2363b2dbc0251a4a6b65a5bddb185d0bdad2",  10 * COIN),
    std::make_pair("8adb2363b2dbc0251a4a6b65a5bddb185d0bdad2",  10 * COIN),
    std::make_pair("8adb2363b2dbc0251a4a6b65a5bddb185d0bdad2",  10 * COIN),
    std::make_pair("8adb2363b2dbc0251a4a6b65a5bddb185d0bdad2",  10 * COIN),
