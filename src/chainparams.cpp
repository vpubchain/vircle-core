...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlockMainNet(1581930000, 7417,  0x1f00ffff); // 2020-02-17 17:00:00      
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000c6c6e56dcbe1d3549d6c4dea580b43401c5f0aab20cc6d381ac294a4c5df"));
        assert(genesis.hashMerkleRoot == uint256S("0xaf5b368adac222286cf22c8d3262dd23d805d9a43b065f8fcda0c0918accb7dc"));
        assert(genesis.hashWitnessMerkleRoot == uint256S("0x8fcc382a8a47c410b22898b21992a80908657ad1cfa43a1aa2ee5ededbe6bb76"));
        ...
        checkpointData = {
            {
                { 0,       uint256S("0x0000c6c6e56dcbe1d3549d6c4dea580b43401c5f0aab20cc6d381ac294a4c5df")},
