...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlockMainNet(1564632000, 82104,  0x1f00ffff); // 2019-08-1 12:00:00
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlockTestNet(1564632000, 82104, 0x1f00ffff); //2019-05-14
        consensus.hashGenesisBlock = genesis.GetHash();
