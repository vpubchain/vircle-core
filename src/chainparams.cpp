...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlockMainNet(1564632000, 35127,  0x1f00ffff); // 2019-08-1 12:00:00
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000052d14755fbfc8c021ea8262fe0d4fbbdb7a5bb2a5e8a219c3ade5e939bf7"));
        assert(genesis.hashMerkleRoot == uint256S("0x788fcee6b3e87d1d727ac3a66803321c004b672de01d0886b6fcfcdfb360cc91"));
        assert(genesis.hashWitnessMerkleRoot == uint256S("0x23c86840a3256cfd594111eff5001540bb2cf14f42a67ebc89169e3d65945ddb"));
        ...
        checkpointData = {
            {
                { 0,       uint256S("0x000052d14755fbfc8c021ea8262fe0d4fbbdb7a5bb2a5e8a219c3ade5e939bf7")},
...
public:
    CTestNetParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000bf72a641b2baded105be8016e8b3b3d1697931266bdc832f134f4ea518b8"));
        ...
        checkpointData = {
            {
		        {0,     uint256S("0x0000bf72a641b2baded105be8016e8b3b3d1697931266bdc832f134f4ea518b8")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0xb5b420d66761e672628e32658bab7d235156212c74d0aa7366a77fc477406851"));
        ...
        checkpointData = {
            {
                {0, uint256S("0xb5b420d66761e672628e32658bab7d235156212c74d0aa7366a77fc477406851")},
            }
        };
