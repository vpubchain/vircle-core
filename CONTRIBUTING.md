Contributing to Vircle Core
============================

The Vircle project operates an open contributor model where anyone is
...
The following applies to code changes to the Vircle project..

Whether a pull request is merged into Vircle Core rests with the project merge
...
Patches that change Vircle consensus rules are considerably more involved than
...
[//]: # (Where a patch set proposes to change the Vircle consensus, it must have been
...
The project leader is the release manager for each Vircle Core release.
