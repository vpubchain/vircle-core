...
Note, Legacy Stealth Addresses are not supported on Hardware Signing Devices. If you have WCL/tPART received on the Legacy Stealth Addresses then we suggest you send those WCL/tPART to a non-Stealth Address before attempting to use with the Hardware Signing Devices.
