...
VERSION=
commit=false
url=https://github.com/vpubchain/vircle-core
proc=2
mem=3000
lxc=true
docker=false
...
-u|--url        Specify the URL of the repository. Default is https://github.com/vpubchain/vircle-core
...
then
    ...
    make -C ../vircle-core/depends download SOURCES_PATH=`pwd`/cache/common
...
then
    ...
    echo ""
    ./bin/gverify -v -d ../gitian.sigs/ -r ${VERSION}-linux ../vircle-core/contrib/gitian-descriptors/gitian-linux.yml
    # Windows
    echo ""
    echo "Verifying v${VERSION} Windows"
    echo ""
    ./bin/gverify -v -d ../gitian.sigs/ -r ${VERSION}-win-unsigned ../vircle-core/contrib/gitian-descriptors/gitian-win.yml
    # Mac OSX
    echo ""
    echo "Verifying v${VERSION} Mac OSX"
    echo ""
    ./bin/gverify -v -d ../gitian.sigs/ -r ${VERSION}-osx-unsigned ../vircle-core/contrib/gitian-descriptors/gitian-osx.yml
    # Signed Windows
    echo ""
    echo "Verifying v${VERSION} Signed Windows"
    echo ""
    ./bin/gverify -v -d ../gitian.sigs/ -r ${VERSION}-osx-signed ../vircle-core/contrib/gitian-descriptors/gitian-osx-signer.yml
    # Signed Mac OSX
    echo ""
